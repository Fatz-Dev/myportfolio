...
const projectFiltersBad = `                <div id="project-filters" class="flex flex-wrap justify-center gap-3 reveal">
...
const projectFiltersGood = `                <div id="project-filters" class="flex flex-wrap justify-center gap-3 reveal">
                    <!-- Injected via JS -->
                </div>`;

html = html.replace(projectFiltersBad, projectFiltersGood);

const projectsContainerBad = `<div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 transition-opacity duration-300" id="projects-container">
...
const projectsContainerGood = `<div class="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 transition-opacity duration-300" id="projects-container">
                <!-- Injected via JS -->
            </div>`;

html = html.replace(projectsContainerBad, projectsContainerGood);
...
const expContainerOrig = `<div class="space-y-12" id="experience-container">
                    <!-- Injected via JS -->
                </div>`;
const expContainerNew = `<div class="space-y-12" id="experience-container">
${expSkeleton}
                </div>`;
html = html.replace(expContainerOrig, expContainerNew);

const certGridOrig = `<div id="certificates-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
                <!-- Injected via JS -->
            </div>`;
const certGridNew = `<div id="certificates-grid" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
${certSkeleton}
            </div>`;
html = html.replace(certGridOrig, certGridNew);
